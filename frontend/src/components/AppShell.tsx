  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50 relative selection:bg-purple-100 selection:text-purple-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative z-10">
        <header className="h-16 border-b border-white/50 bg-white/40 backdrop-blur-md flex items-center justify-between px-8 shrink-0 z-20 shadow-sm shadow-slate-200/50">
        ...
        <main className="flex-1 overflow-y-auto p-8 shadow-inner bg-white/30 backdrop-blur-[2px]">
          <Outlet />
        </main>
      </div>
    </div>
