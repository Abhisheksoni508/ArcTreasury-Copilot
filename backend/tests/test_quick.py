...
def test_alice_approved():
    ...
    result = evaluate_item("0xA11CE00000000000000000000000000000000001", 2500, "ethereum", "payroll")
...
def test_bob_approved():
    ...
    result = evaluate_item("0xB0B0000000000000000000000000000000000002", 8000, "polygon", "vendor")
    assert result.decision == "APPROVED"
    assert result.risk_score < 25
...
def test_charlie_review():
    ...
    result = evaluate_item("0xC0FFEE0000000000000000000000000000000003", 50000, "arbitrum", "vendor")
...
def test_diana_held():
    ...
    result = evaluate_item("0xD1A6000000000000000000000000000000000004", 15000, "ethereum", "revenue_split")
...
def test_echo_queued():
    ...
    result = evaluate_item("0xE000000000000000000000000000000000000006", 18000, "solana", "payroll")
...
def test_fraudster_rejected():
    ...
    result = evaluate_item("0xBADF00D000000000000000000000000000000007", 100000, "ethereum", "vendor")
...
def test_arc_chain_approved():
    ...
    result = evaluate_item("0xFACE000000000000000000000000000000000005", 5000, "arc", "revenue_split")
    assert result.decision == "APPROVED"
    assert result.risk_score < 25
